...
IF (WIN32)
   ...
   SET(CMAKE_LINK_FLAGS "${CMAKE_LINK_FLAGS} /LIBPATH:${INSTALL_ROOT}/lib")
ELSE (WIN32)
   IF ("${DEPS_INCLUDE_DIR}" STREQUAL "")
   ...
   SET(CMAKE_LINK_FLAGS "${CMAKE_LINK_FLAGS} -L${INSTALL_ROOT}/lib")

   IF ("${CMAKE_SYSTEM_NAME}" STREQUAL "SunOS")
      SET(CMAKE_LINK_FLAGS "${CMAKE_LINK_FLAGS} -R${INSTALL_ROOT}/lib")
   ELSEIF (!APPLE)
      SET(CMAKE_LINK_FLAGS "${CMAKE_LINK_FLAGS} -Wl,--rpath,${INSTALL_ROOT}/lib")
   ENDIF ()
ENDIF (WIN32)
