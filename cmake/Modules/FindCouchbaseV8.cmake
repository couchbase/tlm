...
if (NOT DEFINED V8_FOUND)
    ...
    if (WIN32)
        ...
        if (NOT V8_LIBRARIES)
            set(_v8_libraries "v8.dll;v8_libplatform.dll;v8_libbase.dll;icuuc.dll;third_party_abseil-cpp_absl.dll;third_party_icu_icui18n.dll;third_party_zlib.dll")
            foreach (_mylib ${_v8_libraries})
                ...
                if (_the_lib)
                    ...
                    message(FATAL_ERROR "Didn't find V8 library ${_mylib}!")
                endif (_the_lib)
            endforeach (_mylib)
        ...
        if (NOT V8_LIBRARIES)
            set(_v8_libraries "v8;v8_libplatform;v8_libbase;chrome_zlib;icuuc;third_party_abseil-cpp_absl;third_party_icu_icui18n")
            foreach (_mylib ${_v8_libraries})
                unset(_the_lib CACHE)
                find_library(_the_lib
                             NAMES ${_mylib}
