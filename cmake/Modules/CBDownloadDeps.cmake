IF (NOT CBDownloadDeps_INCLUDED)
  ...
  FUNCTION (DECLARE_DEP name)
    ...
    SET (_found_platform "")
    FOREACH (_dep_platform ${dep_PLATFORMS})
      FOREACH (_local_platform ${_local_platforms})
        IF (_dep_platform STREQUAL _local_platform)
          SET (_found_platform ${_local_platform})
          BREAK ()
        ENDIF ()
      ENDFOREACH (_local_platform)
    ENDFOREACH (_dep_platform)
