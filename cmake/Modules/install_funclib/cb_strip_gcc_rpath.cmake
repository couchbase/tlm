...
FUNCTION (_strip_gcc_rpath_real binary)
...
ENDFUNCTION (_strip_gcc_rpath_real)
...
IF (UNIX AND NOT APPLE)
    ...
    IF (chrpath)
        MACRO (cb_strip_gcc_rpath binary)
            # Call the function to strip the RPATH
            _strip_gcc_rpath_real("${binary}")
        ENDMACRO (cb_strip_gcc_rpath)
    ENDIF ()
ENDIF ()

IF (NOT COMMAND cb_strip_gcc_rpath)
