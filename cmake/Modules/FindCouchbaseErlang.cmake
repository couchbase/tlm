  ...
  MACRO (Rebar)
    ...
    IF (DEFINED OPENSSL_LIBRARIES)
      ...
      FOREACH (openssl_lib ${OPENSSL_LIBRARIES})
        GET_FILENAME_COMPONENT (openssl_lib_name "${openssl_lib}" NAME)
        IF (openssl_lib_name MATCHES "crypto")
          SET (OPENSSL_CRYPTO_LIBRARY "${openssl_lib}")
          GET_FILENAME_COMPONENT(OPENSSL_LIB_DIR "${OPENSSL_CRYPTO_LIBRARY}" PATH)
          BREAK ()
        ENDIF ()
      ENDFOREACH ()
    ENDIF ()
