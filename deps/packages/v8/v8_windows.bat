...
echo solutions = [ { "url": "https://github.com/couchbasedeps/v8-mirror.git@7.1.321","managed": False, "name": "v8", "deps_file": "DEPS", }, ]; > .gclient
...
set V8_ARGS=target_cpu=""x64"" is_component_build=true v8_enable_backtrace=true v8_use_snapshot=true v8_use_external_startup_data=false
