...
DECLARE_DEP (curl VERSION 7.39.0-cb1 PLATFORMS centos6 centos7 debian7 ubuntu12.04 ubuntu14.04)
...
DECLARE_DEP (erlang VERSION mb11917-cb5 PLATFORMS centos6 ubuntu12.04)
DECLARE_DEP (gperftools VERSION 2.2 PLATFORMS windows_msvc)
DECLARE_DEP (icu4c VERSION 53.1.0 PLATFORMS windows_msvc)
DECLARE_DEP (icu4c VERSION 263593-cb3 PLATFORMS centos6 ubuntu12.04)
...
DECLARE_DEP (jemalloc VERSION 5d9732f-cb2 PLATFORMS macosx ubuntu12.04 ubuntu14.04 debian7)
...
DECLARE_DEP (libevent VERSION 2.0.21-cb1 PLATFORMS centos6 centos7 macosx ubuntu12.04 ubuntu14.04)
...
DECLARE_DEP (v8 VERSION e24973a-cb1 PLATFORMS centos6 centos7 macosx ubuntu12.04 ubuntu14.04)


#
# This is the new packaging module
#
DECLARE_DEP(curl VERSION 7.40.0-cb1 PLATFORMS sunos)
DECLARE_DEP(icu4c VERSION 263593-cb4 PLATFORMS sunos)
DECLARE_DEP(jemalloc VERSION 5d9732f-cb5 PLATFORMS sunos)
DECLARE_DEP(libevent VERSION 2.0.22-cb1 PLATFORMS sunos)
#DECLARE_DEP(otp VERSION R16B03-cb1 PLATFORMS sunos)
DECLARE_DEP(python-snappy VERSION amd64-c97d633 PLATFORMS snappy)
DECLARE_DEP(snappy VERSION 1.1.1-cb2 PLATFORMS sunos)
DECLARE_DEP(v8 VERSION e24973a-cb2 PLATFORMS sunos)
