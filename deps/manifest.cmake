...
DECLARE_DEP (boost VERSION 1.62.0-cb3 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (curl VERSION 7.60.0-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (erlang VERSION OTP-20.3.8.8-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (erlang VERSION OTP-20.3.2-cb5 PLATFORMS windows_msvc2015)
...
DECLARE_DEP (flex VERSION 2.6.4-cb4 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04)
...
DECLARE_DEP (jemalloc VERSION 4.5.0.1-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (json VERSION 3.1.2-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (libevent VERSION 2.1.8-cb4 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (libuv VERSION 1.20.3-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (lz4 VERSION 1.8.0-cb2 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (maven VERSION 3.5.2-cb5 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (numactl VERSION 2.0.11-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (openjdk-rt VERSION 1.8.0.171-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (rocksdb VERSION 5.12.5-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04)
...
DECLARE_DEP (zlib VERSION 1.2.11-cb3 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
