...
DECLARE_DEP (boost VERSION 1.67.0-cb3 PLATFORMS centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
# curl 7.60.0-cb1 debian7 suse11
DECLARE_DEP (curl VERSION 7.60.0-cb1 PLATFORMS debian7 suse11)
DECLARE_DEP (curl VERSION 7.61.1-cb2 PLATFORMS centos6 centos7 debian8 debian9 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (double-conversion VERSION 3.0.0-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (folly VERSION v2018.08.13.00-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (glog VERSION 0.3.5-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (libevent VERSION 2.1.8-cb4 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (libuv VERSION 1.20.3-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (lz4 VERSION 1.8.0-cb2 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (maven VERSION 3.5.2-cb5 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (numactl VERSION 2.0.11-cb1 PLATFORMS centos6 centos7 debian7 debian8 debian9 suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04)
DECLARE_DEP (openjdk-rt VERSION 1.8.0.171-cb1 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (snappy VERSION 1.1.1-cb2 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04)
...
DECLARE_DEP (zlib VERSION 1.2.11-cb3 PLATFORMS centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
