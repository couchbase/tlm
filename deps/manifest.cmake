...
#
DECLARE_DEP (AWSSDK V2 VERSION 1.11.800 BUILD 1 PLATFORMS linux macosx)
...
DECLARE_DEP (cbpy V2 VERSION 3.14.2 BUILD 6 PLATFORMS linux macosx windows DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python/interp")
DECLARE_DEP (curl V2 VERSION 8.21.0 BUILD 2 PLATFORMS linux macosx windows)
DECLARE_DEP (double-conversion VERSION 3.3.0-cb1 PLATFORMS linux macosx windows)
DECLARE_DEP (erlang V2 VERSION 28.5.0.5 BUILD 1 PLATFORMS linux macosx windows)
# CUDA GPU support is only available on Linux
IF(ENABLE_CUDA_GPU AND NOT WIN32 AND NOT APPLE)
  SET(FAISS_BUILD "30_avx2-gpu")
ELSE()
  SET(FAISS_BUILD "30_avx2")
ENDIF()
DECLARE_DEP (faiss V2 VERSION 1.13.2 BUILD ${FAISS_BUILD} PLATFORMS linux macosx windows)
...
DECLARE_DEP (fmt VERSION 12.2.0-cb1 PLATFORMS linux macosx windows)
DECLARE_DEP (gflags V2 VERSION 2.2.2 BUILD 1 PLATFORMS linux macosx windows)
DECLARE_DEP (folly VERSION v2022.05.23.00-couchbase-cb7_avx2 PLATFORMS linux macosx windows)
...
DECLARE_DEP (grpc V2 VERSION 1.78.1 BUILD 1 PLATFORMS linux macosx windows)
...
# in this same directory!
#
DECLARE_DEP (jemalloc V2 VERSION 5.3.1 BUILD 14 PLATFORMS linux macosx windows)
...
DECLARE_DEP (libevent VERSION 2.1.13-cb4 PLATFORMS linux macosx windows)
...
DECLARE_DEP (openssl V2 VERSION 3.5.7 BUILD 1 PLATFORMS linux macosx windows)
DECLARE_DEP (numactl VERSION 2.0.11-cb4 PLATFORMS linux)
DECLARE_DEP (prometheus V2 VERSION 3.11.3 BUILD 1 GO_DEP PLATFORMS linux macosx windows)
DECLARE_DEP (prometheus-cpp VERSION v1.2.1-couchbase-cb1 PLATFORMS linux macosx windows)
DECLARE_DEP (protoc-gen-go V2 VERSION 1.36.11 BUILD 1 PLATFORMS linux macosx windows)
