...
DECLARE_DEP (breakpad V2 VERSION 20200430 BUILD 1 PLATFORMS ubuntu20.04)
...
# NOTE: If you change cbpy versions, be sure to read tlm/python/README.txt!
DECLARE_DEP (cbpy VERSION 7.0.4-cb7 PLATFORMS amzn2 centos7 centos8 debian9 debian10 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 ubuntu20.04 windows_msvc2017)
DECLARE_DEP (curl V2 VERSION 7.66.0 BUILD 4 PLATFORMS amzn2 centos7 centos8 debian8 debian9 debian10 rhel8 suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2017)
DECLARE_DEP (curl V2 VERSION 7.66.0 BUILD 8 PLATFORMS macosx ubuntu20.04)
...
DECLARE_DEP (erlang VERSION OTP-20.3.8.11-cb13 PLATFORMS amzn2 centos7 centos8 debian8 debian9 debian10 macosx rhel8 suse12 suse15 ubuntu16.04 ubuntu18.04 ubuntu20.04 windows_msvc2017)
...
DECLARE_DEP (flex VERSION 2.6.4-cb6 PLATFORMS centos8 debian10 rhel8 ubuntu20.04)
DECLARE_DEP (folly VERSION v2019.08.12.00-cb2 PLATFORMS amzn2 centos7 centos8 debian8 debian9 debian10 macosx rhel8 suse12 suse15 ubuntu16.04 ubuntu18.04 ubuntu20.04 windows_msvc2017)
...
DECLARE_DEP (gflags VERSION 2.2.1-cb4 PLATFORMS centos8 debian10 rhel8 ubuntu20.04 SKIP)
...
DECLARE_DEP (grpc VERSION 1.12.0-cb11 PLATFORMS ubuntu20.04)
DECLARE_DEP (jemalloc VERSION 5.2.1-cb5 PLATFORMS amzn2 centos7 debian9 debian10 macosx rhel8 suse12 suse15 ubuntu16.04 ubuntu18.04 ubuntu20.04 windows_msvc2017)
DECLARE_DEP (jemalloc VERSION 5.2.1-cb6 PLATFORMS centos8)
...
DECLARE_DEP (openssl V2 VERSION 1.1.1l BUILD 1 PLATFORMS amzn2 centos7 centos8 debian9 debian10 macosx rhel8 suse12 suse15 ubuntu16.04 ubuntu18.04 ubuntu20.04 windows_msvc2017)
...
DECLARE_DEP (protoc-gen-go V2 VERSION 1.2.5 BUILD 3 PLATFORMS ubuntu20.04)
...
DECLARE_DEP (rocksdb VERSION 5.18.3-cb4 PLATFORMS centos8 debian10 rhel8 ubuntu20.04)
