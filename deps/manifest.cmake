...
#
DECLARE_DEP (benchmark VERSION v1.6.2-cb1 PLATFORMS linux macosx windows)
...
DECLARE_DEP (cbpy VERSION 7.5.0-cb2 PLATFORMS linux macosx windows DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python/interp")
...
DECLARE_DEP (erlang V2 VERSION 25.3 BUILD 5 PLATFORMS linux macosx windows)
DECLARE_DEP (flatbuffers VERSION 1.10.0-cb5 PLATFORMS macosx)
DECLARE_DEP (flatbuffers VERSION 1.10.0-cb6 PLATFORMS linux windows)
DECLARE_DEP (fmt VERSION 8.1.1-cb3 PLATFORMS linux macosx windows)
DECLARE_DEP (folly VERSION v2022.05.23.00-couchbase-cb9 PLATFORMS linux macosx windows)
DECLARE_DEP (glog VERSION v0.4.0-cb2 PLATFORMS linux macosx windows)
DECLARE_DEP (googletest VERSION 1.11.0-cb5 PLATFORMS linux macosx windows)
DECLARE_DEP (grpc VERSION 1.49.2-cb7 PLATFORMS linux macosx windows)
#
# IMPORTANT: If you add a new package here or update an existing package
# version, you must also update couchbase-server-black-duck-manifest.json
# in this same directory!
...
DECLARE_DEP (json VERSION 3.9.0-cb2 PLATFORMS linux macosx windows)
...
DECLARE_DEP (pcre VERSION 8.44-cb2 PLATFORMS linux macosx windows)
...
DECLARE_DEP (prometheus-cpp VERSION v0.10.0-couchbase-cb3 PLATFORMS linux macosx windows)
...
DECLARE_DEP (rocksdb VERSION 5.18.3-cb7 PLATFORMS linux macosx)
ENDIF (NOT CB_PRODUCTION_BUILD)
DECLARE_DEP (snappy VERSION 1.1.8-cb5 PLATFORMS linux macosx windows)
DECLARE_DEP (spdlog VERSION v1.10.0-cb5 PLATFORMS linux macosx windows)
DECLARE_DEP (v8 V2 VERSION 11.4.127 BUILD 2 PLATFORMS linux macosx windows)
