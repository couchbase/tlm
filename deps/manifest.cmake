...
DECLARE_DEP (boost VERSION 1.74.0-cb2 PLATFORMS linux macosx windows)
DECLARE_DEP (cbpy VERSION 7.5.0-cb2 PLATFORMS linux macosx windows DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python/interp")
DECLARE_DEP (curl V2 VERSION 7.88.1 BUILD 4_openssl30x PLATFORMS linux macosx windows)
...
DECLARE_DEP (folly VERSION v2022.05.23.00-couchbase-cb8 PLATFORMS amzn2 centos7 debian9 debian10 macosx suse12 suse15 ubuntu18.04 ubuntu20.04 windows)
...
DECLARE_DEP (grpc VERSION 1.49.2-cb4 PLATFORMS linux macosx windows)
#
# IMPORTANT: If you add a new package here or update an existing package
# version, you must also update couchbase-server-black-duck-manifest.json
# in this same directory!
#
DECLARE_DEP (jemalloc VERSION 5.3.0-cb1 PLATFORMS linux macosx windows)
...
DECLARE_DEP (libevent VERSION 2.1.11-cb8 PLATFORMS linux macosx windows)
DECLARE_DEP (libsodium V2 VERSION 1.0.18 BUILD 4 PLATFORMS linux macosx windows)
...
DECLARE_DEP (prometheus V2 VERSION 2.33.3 BUILD 3 PLATFORMS linux macosx windows_msvc2017)
