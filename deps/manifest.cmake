...
DECLARE_DEP (boost VERSION 1.67.0-cb3 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
# curl 7.60.0-cb1 debian7 suse11
DECLARE_DEP (curl VERSION 7.60.0-cb1 PLATFORMS debian7 suse11)
DECLARE_DEP (curl VERSION 7.61.1-cb2 PLATFORMS amzn2 centos6 centos7 debian8 debian9 suse12 suse15 ubuntu14.04 ubuntu16.04 windows_msvc2015)
DECLARE_DEP (curl VERSION 7.61.1-cb3 PLATFORMS ubuntu18.04)
DECLARE_DEP (double-conversion VERSION 3.0.0-cb1 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (erlang VERSION OTP-20.3.8.11-cb1 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (flatbuffers VERSION 1.10.0-cb2 PLATFORMS centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 ubuntu14.04 ubuntu16.04 windows_msvc2015 amzn2 suse15 ubuntu18.04)
...
DECLARE_DEP (folly VERSION v2018.08.13.00-cb1 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (glog VERSION 0.3.5-cb1 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (grpc VERSION 1.17.2-cb1 PLATFORMS amzn2 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (json VERSION 3.1.2-cb1 PLATFORMS amzn2 centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (libevent VERSION 2.1.8-cb4 PLATFORMS amzn2 centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 windows_msvc2015)
DECLARE_DEP (libevent VERSION 2.1.8-cb5 PLATFORMS ubuntu18.04)
DECLARE_DEP (libuv VERSION 1.20.3-cb1 PLATFORMS amzn2 centos6 centos7 debian7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (maven VERSION 3.5.2-cb5 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (openjdk-rt VERSION 1.8.0.171-cb1 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
DECLARE_DEP (openssl VERSION 1.0.2k-cb2 PLATFORMS windows_msvc2015)
DECLARE_DEP (openssl VERSION 1.0.2k-cb3 PLATFORMS macosx)
DECLARE_DEP (pcre VERSION 8.42-cb1 PLATFORMS amzn2 centos7 debian8 debian9 macosx suse12 suse15 ubuntu16.04 ubuntu18.04 windows_msvc2015)
...
DECLARE_DEP (zlib VERSION 1.2.11-cb3 PLATFORMS amzn2 centos6 centos7 debian8 debian9 macosx suse11 suse12 suse15 ubuntu14.04 ubuntu16.04 ubuntu18.04 windows_msvc2015)
